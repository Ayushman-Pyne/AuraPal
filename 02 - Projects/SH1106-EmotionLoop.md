...
| Type  | Name                  | Variables                                | Function                                                             |     |
| ----- | --------------------- | ---------------------------------------- | -------------------------------------------------------------------- | --- |
| class | RoboEyes              | AdafruitDisplay &disp                    | Main class for rendering and animating robotic eyes on OLED displays |     |
| func  | RoboEyes              | AdafruitDisplay &disp                    | Constructor that links the display object                            |     |
| func  | begin                 | int width, int height, byte frameRate    | Initializes display settings, clears screen, and sets frame rate     |     |
| func  | update                | —                                        | Updates and redraws eyes based on frame timing                       |     |
| func  | setFramerate          | byte fps                                 | Sets animation frame rate (FPS control)                              |     |
| func  | setDisplayColors      | uint8_t background, uint8_t main         | Sets background and drawing colors                                   |     |
| func  | setWidth              | byte leftEye, byte rightEye              | Sets width of left and right eyes                                    |     |
| func  | setHeight             | byte leftEye, byte rightEye              | Sets height of left and right eyes                                   |     |
| func  | setBorderRadius       | byte leftEye, byte rightEye              | Sets corner roundness of eyes                                        |     |
| func  | setSpacebetween       | int space                                | Sets spacing between both eyes                                       |     |
| func  | setMood               | unsigned char mood                       | Sets emotional expression (tired, angry, happy, default)             |     |
| func  | setPosition           | unsigned char position                   | Moves eyes to predefined screen positions                            |     |
| func  | setAutoblinker        | bool active, int interval, int variation | Enables auto blinking with timing control                            |     |
| func  | setAutoblinker        | bool active                              | Enables/disables auto blinking                                       |     |
| func  | setIdleMode           | bool active, int interval, int variation | Enables random eye movement with timing                              |     |
| func  | setIdleMode           | bool active                              | Enables/disables idle mode                                           |     |
| func  | setCuriosity          | bool curiousBit                          | Enlarges outer eye when looking sideways                             |     |
| func  | setCyclops            | bool cyclopsBit                          | Switches to single-eye mode                                          |     |
| func  | setHFlicker           | bool flickerBit, byte amplitude          | Enables horizontal flicker with intensity                            |     |
| func  | setHFlicker           | bool flickerBit                          | Enables/disables horizontal flicker                                  |     |
| func  | setVFlicker           | bool flickerBit, byte amplitude          | Enables vertical flicker with intensity                              |     |
| func  | setVFlicker           | bool flickerBit                          | Enables/disables vertical flicker                                    |     |
| func  | setSweat              | bool sweatBit                            | Enables sweat animation                                              |     |
| func  | getScreenConstraint_X | —                                        | Returns max horizontal movement limit                                |     |
| func  | getScreenConstraint_Y | —                                        | Returns max vertical movement limit                                  |     |
| func  | close                 | —                                        | Closes both eyes                                                     |     |
| func  | open                  | —                                        | Opens both eyes                                                      |     |
| func  | blink                 | —                                        | Triggers blink animation                                             |     |
| func  | close                 | bool left, bool right                    | Closes selected eye(s)                                               |     |
| func  | open                  | bool left, bool right                    | Opens selected eye(s)                                                |     |
| func  | blink                 | bool left, bool right                    | Blinks selected eye(s)                                               |     |
| func  | anim_confused         | —                                        | Triggers horizontal shaking animation                                |     |
| func  | anim_laugh            | —                                        | Triggers vertical shaking animation                                  |     |
| func  | drawEyes              | —                                        | Core function that computes animations and renders eyes              | \   |
|       |                       |                                          |                                                                      |     |

## ***Sample TEST CODE*** (main.cpp)
```Cpp
#include <Arduino.h>
#include <Wire.h>
